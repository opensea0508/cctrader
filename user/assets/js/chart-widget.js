...
var optionscolumnchart = {
    ...
    fill: {
        colors:[WingoAdminConfig.primary, WingoAdminConfig.secondary],
        type: 'gradient',
        gradient: {
            shade: 'light',
            type: 'vertical',
...
var optionssaleschart = {
    ...
    colors:[WingoAdminConfig.primary, WingoAdminConfig.secondary, '#e2c636'],
    chart: {
        height: 300,
        type: 'radar',
        dropShadow: {
...
var optionsuserchart = {
    ...
    colors:[WingoAdminConfig.primary, WingoAdminConfig.secondary, '#222222', '#e2c636'],
    title: {
...
// browser-candlestick chart
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    ...
                    downward: WingoAdminConfig.secondary
                }
            }
        },
        fill: {
    ...
    var optionsProgress1 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [WingoAdminConfig.primary]
            }
        },
        series: [{
            name: 'Process 1',
    ...
    var optionsProgress3 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [WingoAdminConfig.secondary]
            }
        },
        title: {
            floating: true,
