				...
				<div class="modal-body">
					...
					<form action="controller" method="post">
						...
						<div class="">
							...
							<div class="form-group ">
								<div class="radio radio-primary" style="display: flex; align-items: baseline; gap: 4px;">
								...
								<div class="radio radio-secondary" style="display: flex; align-items: baseline; gap: 4px;">
