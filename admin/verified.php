              ...
              <div class="col-xl-12">
                <div class="row">
                  <div class="col-xl-12 col-sm-6">
                    ...
                    $sql = runQuery("SELECT * FROM dregister WHERE dlevel='user' AND dvastatus='Verified' ORDER BY id DESC LIMIT 200");
                      if(numRows($sql)>0){
                    ?>
                      <div class="table-responsive" style="min-height: 250px;">
                        <table class="table">
                          ...
                          <?php while($row=fetchAssoc($sql)){?>
                            ...
                            <td>
                            <a class="btn btn-danger btn-sm" href="user-details?id=<?php echo ($row['userid']).'&email='.$row['demail']  ?>"> <i class="fa fa-eye"></i> Details</a>
                            </td>
                            </tr>
                            <?php } ?>
