                ...
                <div class="col-6">
                  <div class="breadcrumb-sec">
                    <ul class="breadcrumb"> 
                      ...
                      <li class="breadcrumb-item">Paid Request</li> 
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div class="row ">
             ...
             <div class="card">
              ...
              <div class="table-responsive">
                ...
                <tbody>
                    <?php
                    $wal = runQuery("SELECT * FROM ddeposit WHERE dstatus='confirmed' LIMIT 150");
                    if(numRows($wal)>0){
                    ...
                    <?php if($wall['dstatus']=="pending"){ ?>
                        ...
                        <a href="depo-details?tid=<?php echo $wall['did']; ?>" class="btn btn-xs btn-info">Details</a>
