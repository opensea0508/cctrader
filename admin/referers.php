                      ...
                      <div class="table-responsive" style="min-height: 250px;">
                        <table class="table">
                          ...
                          <?php while($row=fetchAssoc($sql)){?>
                            ...
                            <td>
                            <a class="btn btn-primary btn-sm" data-id="<?php echo $row['id']  ?>" data-email="<?php echo $_GET['email']  ?>" data-userid="<?php echo $_GET['userid']?>" data-status="client1" id="setReferer"> SET</a>
                            </td>
                            </tr>
                            <?php } ?>
